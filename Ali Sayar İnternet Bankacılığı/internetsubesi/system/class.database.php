<?php
	       ...
	       //////////////////////////////////////////////////////
	      ///                                                ///
		 ///	Dosya      : class.sincap.php               ///
        ///     Class      : Sincap                        ///
	   ///		Hazırlayan : Halil SAVAŞCI                ///
	  ///	    E-Posta    : halilsavasci32@gmail.com    ///
	 ///		Cep Telç   : +90-543-928-37-48          ///
	///                                                ///
   //////////////////////////////////////////////////////
	...
	class Database{
		...
		private $VtKullanici  = "root";  // Veritabanı kullanıcıadı.
		private $VtParola     = "123";  // Veritabanı parolası.
		private $VtAd         = "internetbankaciligi";  // Bağlanılacak veritabanı adı.
		...
		*/
		public function TekVeriCek($Tablo, $Alan, $Deger){
			$Sql = "SELECT * FROM " . Ttablo . " WHERE " . $Alan . " =?" ;
			$this->Sorgula($Sql);
