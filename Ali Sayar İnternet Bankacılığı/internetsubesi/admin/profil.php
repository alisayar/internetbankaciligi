...
<div class="row">
    ...
    <div class="row">
        <form action="../system/admin/profilCepTelGuncelle.php" method="post">
    ...
    <div class="row">
        <form action="../system/admin/profilEmailGuncelle.php" method="post">
            <input type="text" name="id" value="<?=$profil["musteri_id"]?>" hidden />
    ...
    <div class="row">
        <form action="../system/admin/profilAdresGuncelle.php" method="post">
            <input type="text" name="id" value="<?=$profil["musteri_id"]?>" hidden />
